...
class WeatherDto {
  ...
  WeatherDto({this.location, this.current, this.forecast});
  ...
  WeatherModel toWeatherModel() {
    return WeatherModel(
        ...
        date: DateTime.parse(current!.lastUpdated!),
        temp: forecast!.forecastday![0].day!.avgtempC!,
        maxTemp: forecast!.forecastday![0].day!.maxtempC!,
        image: 'https:${forecast!.forecastday![0].day!.condition!.icon!}',
        minTemp: forecast!.forecastday![0].day!.mintempC!,
        weatherStateName: forecast!.forecastday![0].day!.condition!.text!);
  }
}
